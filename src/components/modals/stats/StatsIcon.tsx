...
export default function StatsIcon(props: Props) {
  return (
    <svg className='fill-[#818181] dark:fill-[#DADCE0] stroke-[#F3F3F3] dark:stroke-dark-bg' width="40" height="36" viewBox="0 0 40 36" fill="inherit" xmlns="http://www.w3.org/2000/svg" {...props}>
